...
def initialize_parameters():
    ...
    W1 = tf.get_variable("W1", [256, 12288], initializer = tf.contrib.layers.xavier_initializer(seed = 1))
    ...
    W3 = tf.get_variable("W3", [6,  128], initializer = tf.contrib.layers.xavier_initializer(seed = 1))
